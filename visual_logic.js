...
registerOnDrag('drag_move', false, [0,1,2], function() {}, function() {
  dragMoveAdv('sudhi_armature', 'XY', 'WORLD', 'gLg/k;R@aiJaT=MZ,oIy', '?fhuE)u^Xl*T~C^0}P~%');
}, function() {}, '?fhuE)u^Xl*T~C^0}P~%');

registerOnDrag('drag_rotate', false, [0,1,2], function() {}, function() {
  dragRotateAdv('sudhi_armature', 'Z', 'WORLD', '8gL3$v1lr[@4#r!0S(a5', 'k0kzN@zMl8qqdrD%bE5v');
}, function() {}, 'k0kzN@zMl8qqdrD%bE5v');

registerOnDrag('drag_scale', false, [0,1,2], function() {}, function() {
  dragScale('sudhi_armature', 'Z', 'xrhena@0zP[^Rj@/@5eF', '0-+Lw`%[*#J,)EdOiVHc');
  dragScale('sudhi_armature', 'X', 'KHa]mXQ:M1nP-b7;}S.X', '0-+Lw`%[*#J,)EdOiVHc');
  dragScale('sudhi_armature', 'Y', '_VHp+r4QV!%g8lX?P060', '0-+Lw`%[*#J,)EdOiVHc');
  updateTextObj('scale_percentage', String(Math.round(toFixedPoint(getObjTransform('sudhi_armature', false, 'scale', 'z'), 2) * 100)) + '%');
}, function() {}, '0-+Lw`%[*#J,)EdOiVHc');
